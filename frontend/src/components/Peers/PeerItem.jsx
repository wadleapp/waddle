...
const PeerItem = ({ name, description, icon }) => {
  ...
  return (
    <div className="history-item flex-r">
      ...
      <img className="history-view-more" onClick={() => setIceBerg(true)} src={Pencil} alt="Edit" />
      <ReactModal isOpen={iceBerg}>
        <Level />
        <p className="btn btn-primary--blue-vibrant" onClick={() => setIceBerg(false)}>
          Close
        </p>
      </ReactModal>
    </div>
